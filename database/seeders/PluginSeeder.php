...
class PluginSeeder extends Seeder
{
    ...
    private function getSettings(): array
    {
        return [
            ...
            ['space' => 'bank_transfer', 'name' => 'bank_name', 'value' => 'Techcombank'],
            ['space' => 'bank_transfer', 'name' => 'bank_account', 'value' => '19038752078015'],
            ['space' => 'bank_transfer', 'name' => 'bank_username', 'value' => 'Do Giao Linh'],
