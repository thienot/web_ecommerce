...
class PaymentService
{
     ...
     * @param  Order  $order
     */
    public function __construct(Order $order, $qrCodeImage = null)
    {
        $this->order = $order;
     ...
     * @return static
     */
    public static function getInstance(Order $order, $qrCodeImage = null): static
    {
        return new static($order, $qrCodeImage);
    }
    ...
    public function pay(): mixed
    {
        try {
            ...
            return view('orders.pay', ['order' => $this->order,'qr_code_image' => $this->qrCodeImage, 'payment_view' => $viewContent]);
        } catch (Exception $e) {
