...
// VNPay routes
Route::post('/payment/vnpay', [Controllers\PaymentController::class, 'vnpay_payment'])->name('payment.vnpay');
Route::get('/payment/vnpay/return', [Controllers\PaymentController::class, 'vnpay_return'])->name('payment.vnpay.return');


Route::post('/chatbot/ask', [Controllers\ChatbotController::class, 'ask'])->name('chatbot.ask');
Route::get('/chatbot/history', [Controllers\ChatbotController::class, 'getHistory'])->name('chatbot.history');
